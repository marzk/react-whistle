...
function Whistle(Wrapper) {
  ...
  var Container = (function (_Component) {
    ...
    _createClass(Container, [{
      ...
      value: function render() {
        return _react2['default'].createElement(Wrapper, _extends({}, this.props, { onResolve: onResolve, onReject: onReject }));
      }
    }]);
  ...
  var whistle = function whistle() {
    ...
    var component = (0, _reactDom.render)(_react2['default'].createElement(Container, props), wrapper);
